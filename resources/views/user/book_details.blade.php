        ...
        <div class="book-detail"> 
            ...
            <div class="book-info"> 
                ...
                <div class="book-meta"> 
                    ...
                    <p><strong>Nhà xuất bản:</strong> {{ $book->nha_xuat_ban }}</p> 
                    <p><strong>Năm xuất bản:</strong> {{ $book->publication_year }}</p> 
                    <p><strong>Mô tả:</strong> {{ $book->mo_ta }}</p> 

                    <div class="quantity-info">
                        <p><strong>Số lượng:</strong> {{ $book->total_quantity }}</p> 
                        <p><strong>Số lượng còn lại:</strong> {{ $book->available_quantity }} 
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('book.borrow', $book->book_id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="borrower_name" name="borrower_name" class="form-control" value="{{ Auth::user()->username ?? '' }}" readonly>
                </div>
                
                <div class="form-group">
                    <label for="borrower_email">Email:</label>
                    <input type="email" id="borrower_email" name="borrower_email" class="form-control" value="{{ Auth::user()->email ?? '' }}" readonly>
                </div>
                
                <div class="form-group">
                    <label for="borrow_date">Ngày mượn:</label>
                    <input type="text" id="borrow_date" name="borrow_date" class="form-control" value="{{ date('d/m/Y') }}" readonly>
                </div>
                
                <div class="form-group">
                    <label for="return_date">Hạn trả:</label>
                    <input type="text" id="return_date" name="return_date" class="form-control" value="{{ date('d/m/Y', strtotime('+30 days')) }}" readonly>
                </div>
                
                
                <div class="form-group">
                    <label for="book_title">Tên sách:</label>
                    <input type="text" id="book_title" name="book_title" class="form-control" value="{{ $book->book_title }}" readonly>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="quantity" name="quantity" class="form-control">
                        @for ($i = 1; $i <= min(4, $book->available_quantity); $i++)
