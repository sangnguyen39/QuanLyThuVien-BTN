...
<header>
    <nav class="navbar navbar-light navbar-expand-sm banner-navbar">
        <div class="container-fluid">
            <!-- <div class="col-12">
                <a class="navbar-brand text-white fw-bold" href="<?php echo e(url('/')); ?>">Thư viện Hub</a>
            </div> -->
            <div class="auth-box">
                <?php if(auth()->guard()->check()): ?>
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <a class="dropdown-item" href="<?php echo e(route('account')); ?>">Thông tin</a>
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('auth.showlogin')); ?>">
...
<div class="container">
        ...
        <div class="sidebar">
        <a href="<?php echo e(url('/')); ?>"><h4 class="module-title booklibrary-title">TRANG CHỦ</h4></a>
                <div class="category-dropdown">
            <h4 class="module-title category-title">Thể loại</h4>
            <ul class="category-list">
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li>
                        <a href="<?php echo e(route('theloai', ['id' => $category->category_id])); ?>">
                ...
                <li class="see-all">
                    <a href="<?php echo e(route('tatca-sach')); ?>" class="see-all-box">See all book</a>
                </li>
            </ul>
       ...
       <!--  -->
        ...
        <?php $__empty_1 = true; $__currentLoopData = $danhSachThuVien; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $thuVien): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <li>
                <?php if(!empty($thuVien->link_thuvien)): ?>
                    <a href="<?php echo e($thuVien->link_thuvien); ?>" target="_blank" rel="noopener noreferrer">
                        <?php echo e($thuVien->ten_thuvien); ?>

                    </a>
                <?php else: ?>
                    <span><?php echo e($thuVien->ten_thuvien); ?> (Không có link)</span>
                <?php endif; ?>
            </li>
...
.linked-website-dropdown .linked-website-list li span {
    ...
    color: #333;
            ...
            <div class="readers-list">
                ...
                <ul>
                    <?php $__currentLoopData = $recentBorrowers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $borrower): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="reader-item">
                            <!-- <img src="<?php echo e(asset('images/' . $borrower->photo)); ?>" alt="<?php echo e($borrower->username); ?>"> -->
                            <img src="<?php echo e(asset('storage/profile/'.$borrower->photo)); ?>" width="30px" class='mb-1'/>
                            <?php echo e($borrower->username); ?>   
                        </li>  
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="header">
            ...
            <?php if(auth()->guard()->check()): ?>
                <span class="font-weight-bold">Xin chào ~ <?php echo e(Auth::user()->full_name); ?></span>
            <?php endif; ?>
                </div>
        </div>
...
<?php /**PATH D:\laravel\QuanLyThuVien-BTN\resources\views/components/user-layout.blade.php ENDPATH**/ ?>