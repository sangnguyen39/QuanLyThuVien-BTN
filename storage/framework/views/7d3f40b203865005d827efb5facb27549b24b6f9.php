...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/quanli.css')); ?>">
...
<body>
        <div class="sidebar">
            ...
            <ul>
                <li>
                    <a href="<?php echo e(route('admin.index')); ?>" class="<?php echo e(request()->is('admin/dashboard') ? 'active' : ''); ?>">
                        <span class="icon-placeholder"><i class="fas fa-chart-bar"></i></span>
                        <span>Dashboard</span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('admin.qlysach')); ?>"
                        class="<?php echo e(request()->is('admin/admin/quanlysach') ? 'active' : ''); ?>">
                        <span class="icon-placeholder"><i class="fas fa-box"></i></span>
                        <span>Quản lý sách</span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('admin.qlphieumuon')); ?>"
                        class="<?php echo e(request()->is('admin/qlphieumuon') ? 'active' : ''); ?>">
                        <span class="icon-placeholder"><i class="fab fa-wpforms"></i></span>
                        <span>Quản lý phiếu mượn</span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('admin.qlmember')); ?>"
                        class="<?php echo e(request()->is('admin/qlmember') ? 'active' : ''); ?>">
...
</html><?php /**PATH D:\laravel\QuanLyThuVien-BTN\resources\views/admin/master.blade.php ENDPATH**/ ?>