...
<body>
    ...
    <div class="login-container">
        ...
        <div class="form-section">
            ...
            <form action="<?php echo e(route('auth.register')); ?>">
                <button type="submit" class="login-button" style="background-color: rgb(247, 55, 55);">Đăng ký</button>
            </form>
            <br><br>
...
</html><?php /**PATH D:\laravel\QuanLyThuVien-BTN\resources\views/auth/login.blade.php ENDPATH**/ ?>